...
![Project Preview](<img width="1250" height="790" alt="premium-whitelist" src="https://github.com/user-attachments/assets/3a888ea6-19bb-4dfb-9c8a-7e20f848f421" />)

## ✨ Why this template?
- **Modern Aesthetic:** Clean, "Silicon Valley" inspired dark mode.
- **Ultra Performance:** Optimized for Core Web Vitals (Lighthouse 100/100).
- **Conversion Focused:** Designed to turn visitors into waitlist signups.
- **Future-proof:** Uses Next.js 16 App Router and Tailwind CSS 4 engine.
